...
- **Learning Management System (LMS) Backend**  
  API supporting course delivery, student progress tracking, and user-role segregation for instructors and admins.

- **Interview Scheduler + Resume Parser**  
  Automates interview booking with calendar API integrations and resume-to-skill matching using basic NLP.

- **URL Shortener with Analytics**  
  Generates short links with tracking for clicks, referrers, and geodata, with abuse prevention mechanisms.

- **Online Judge Backend**  
  Code submission and evaluation backend across multiple languages, built with sandboxed execution and async task queues.
